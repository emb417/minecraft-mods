...
public class Main {
	...
	public static Block electronicBlock;
	public static Item enderIngot;
	public static Item electronicIngot;
	...
	public void init(FMLInitializationEvent event) {
		...
		electronicBlock = new ElectronicIngotFromElectronicBlock();
		GameRegistry.registerBlock(electronicBlock, "electronicBlock");
		Item electronicBlockItem = GameRegistry.findItem("mymods", "electronicBlock");
		ModelResourceLocation electronicBlockModel = new ModelResourceLocation(
				"mymods:electronicBlock", "inventory");
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
				.register(electronicBlockItem, 0, electronicBlockModel);
		...
		electronicIngot = new ElectronicIngot();
		GameRegistry.registerItem(electronicIngot, "electronicIngot");
		Item electronicIngotItem = GameRegistry.findItem("mymods", "electronicIngot");
		ModelResourceLocation electronicIngotModel = new ModelResourceLocation(
				"mymods:electronicIngot", "inventory");
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
				.register(electronicIngot, 0, electronicIngotModel);
